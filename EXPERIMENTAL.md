...
These are **Deneb 2.1.0 experimental platform builds**, not stable Windows/Linux releases. The application version is 2.1.0; these archives are published separately as v2.1.0-experimental.1. Stable macOS releases remain separate.
...
Это **экспериментальные сборки Deneb 2.1.0 для Windows/Linux**, не стабильный релиз для этих платформ. Версия приложения — 2.1.0; архивы опубликованы отдельно как v2.1.0-experimental.1.
