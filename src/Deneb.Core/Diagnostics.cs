...
public enum DownloadPhase { Queued, GlobalPause, ManualPause, Completed, Failed, NeedsDecision, Probing, ProbeRetry, Transferring, Retrying, Ready, Stopped, Waiting, Assembling, Verifying, DiskPause }
public enum ProblemCode { EmptyInput, InvalidUrl, InvalidSettings, AbsolutePath, StoreLocked, UnsupportedStore, CorruptStore, MissingParts, Persistence, IdentityUnknown, NoResume, Disk, NetworkExhausted, BadRange, UnsafeResume, RangeChanged, TagChanged, UnexpectedResponse, FileChanged, ModifiedChanged, Disconnected, TooMuchData, IncompleteResponse, SegmentSize, FinalSize, FinalMetadata, Timeout, Network, MissingFile, SystemCommand, SystemLaunch, SingleName, IntegerSettings, HttpUnavailable, HttpDenied, HttpRetry, Unexpected, Legacy, Protocol, Incompatible, InterfaceOpen, DisconnectedControl, BackgroundMissing, BackgroundTimeout, UnsupportedPlatform, InsufficientDiskSpace, DiskSpaceUnavailable, InvalidBandwidth, TrashFailed, UnsafeFileType, TaskChanged }
