...
cp artifacts/osx-arm64/deneb README.md LICENSE CHANGELOG.md THIRD-PARTY-NOTICES.md "$staging/"
...
COPYFILE_DISABLE=1 tar -czf artifacts/release/deneb-osx-arm64.tar.gz -C "$staging" deneb README.md LICENSE CHANGELOG.md THIRD-PARTY-NOTICES.md docs licenses
